...
public class ApolloApplicationContextInitializer
    ...
    protected void initialize(ConfigurableEnvironment environment) {
        ...
        // 忽略，若已经有
        // APOLLO_BOOTSTRAP_PROPERTY_SOURCE_NAME(ApolloBootstrapPropertySources)
        // 的 PropertySource
     ...
     * loading logging system phase, this EnvironmentPostProcessor can be called
     * Just After ConfigFileApplicationListener has succeeded.
     *
     * <br />
    ...
    public void postProcessEnvironment(ConfigurableEnvironment configurableEnvironment,
        ...
        // should always initialize system properties like app.id in the first
        // place
        ...
        // EnvironmentPostProcessor should not be triggered if you don't want
        // Apollo Loading before Logging System Initialization
        if (!eagerLoadEnabled) {
            return;
        }
