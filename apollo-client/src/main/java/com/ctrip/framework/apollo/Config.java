...
public interface Config {
    /**
     * Return the property value with the given key, or {@code defaultValue} if
     ...
     * {@code defaultValue} if the name doesn't exist. Will try to parse the
     * date with Locale.US and formats as follows: yyyy-MM-dd HH:mm:ss.SSS,
    ...
    /**
     * Return the Date property value with the given name, or
     * {@code defaultValue} if the name doesn't exist. Will parse the date with
     * the format specified and Locale.US
     *
     * @param key
     *            the property name
     * @param format
     *            the date format, see {@link java.text.SimpleDateFormat} for
     *            more information
     * @param defaultValue
     *            the default value when name is not found or any error occurred
     * @return the property value
    ...
    /**
     * Return the Date property value with the given name, or
     * {@code defaultValue} if the name doesn't exist.
     *
     * @param key
     *            the property name
     * @param format
     ...
     * or {@code
     * defaultValue} if the name doesn't exist. Please note the format should
     * comply with the follow example (case insensitive). Examples:
     * 
     * <pre>
    ...
    /**
     * Add change listener to this config instance, will be notified when any
     * key is changed in this namespace.<br>
     * 添加配置变化监听器
     * 
     * @param listener
    ...
    /**
     * Add change listener to this config instance, will only be notified when
     * any of the interested keys is changed in this namespace.
     *
     * @param listener
     *            the config change listener
     * @param interestedKeys
     *            the keys interested by the listener
     *
     * @since 1.0.0
     */
     ...
     *            the config change listener
     * @param interestedKeys
     *            the keys that the listener is interested in
     * @param interestedKeyPrefixes
     *            the key prefixes that the listener is interested in, e.g.
     *            "spring." means that {@code listener} is interested in keys
     *            that starts with "spring.", such as "spring.banner",
     *            "spring.jpa", etc. and "application" means that
     *            {@code listener} is interested in keys that starts with
     *            "application", such as "applicationName", "application.port",
     *            etc. For more details, see
     *            {@link com.ctrip.framework.apollo.spring.annotation.ApolloConfigChangeListener#interestedKeyPrefixes()}
     ...
     *
     * @param listener
     *            the specific config change listener to remove
     ...
     *            the property name
     * @param function
     *            the transform {@link Function}. from String to user-defined
     *            type
     * @param defaultValue
     *            the default value when key is not found or any error occurred
     * @param <T>
