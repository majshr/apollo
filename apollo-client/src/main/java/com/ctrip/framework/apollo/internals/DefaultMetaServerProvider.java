...
/**
 * 系统属性 -> os env -> server.properties -> app.properties 获取
 * 
 * @author mengaijun
 * @Description: TODO
 * @date: 2020年4月27日 上午11:24:45
 */
public class DefaultMetaServerProvider implements MetaServerProvider {
    ...
    private String initMetaServerAddress() {
        ...
        if (Strings.isNullOrEmpty(metaAddress)) {
            // 2. Get from OS environment variable, which could not contain dot
            // and is normally in UPPER case
    ...
    public String getMetaServerAddress(Env targetEnv) {
        // for default meta server provider, we don't care the actual
        // environment
