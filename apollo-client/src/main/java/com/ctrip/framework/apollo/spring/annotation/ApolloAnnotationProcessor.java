...
/**
 * Apollo Annotation Processor for Spring Application<br>
...
public class ApolloAnnotationProcessor extends ApolloProcessor {
    ...
    protected void processMethod(final Object bean, String beanName, final Method method) {
        ...
        Set<String> interestedKeys = annotatedInterestedKeys.length > 0 ? Sets.newHashSet(annotatedInterestedKeys)
                : null;
