...
/**
 * Instance Config 实体，记录 Instance 对 Namespace 的配置的获取情况。如果一个 Instance 使用了多个
 * Namespace ，则会记录多条 InstanceConfig 。<br>
 * instanceId + configAppId + ConfigNamespaceName 组成唯一索引，因为一个 Instance 可以使用多个
 * Namespace 。
 * 
