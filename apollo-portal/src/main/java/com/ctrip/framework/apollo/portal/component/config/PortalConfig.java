...
/**
 * PortalDB.serverconfig表对应的可刷新配置
 * 
 * @author mengaijun
 * @Description: TODO
 * @date: 2020年4月23日 下午2:50:01
 */
@Component
public class PortalConfig extends RefreshableConfig {
    ...
    /**
     * PortalDB.serverconfig配置, 构造方法注入
     */
    ...
    /**
     * 获取meta信息(apollo.portal.meta.servers)
     * 
     * @return
     */
    ...
    /**
     * 获取email supported envs信息
     * 
     * @return Set<Env>
     * @date: 2020年4月22日 下午6:05:37
     */
